...
const COPY_KEYS: Array<[keyof AuditResult['copy'], string]> = [
...
const STEP_LABELS = [
  ...
  'Mapping sections top to bottom',
  'Reading copy in each section',
  'Writing section-by-section audit',
]
  ...
  const runAudit = async () => {
    ...
    const tryFinalize = () => {
      ...
      const entry: SavedAudit = {
        url: normalized, display: disp, data: apiResult,
        overall, auditTime: new Date().toISOString(), ts: Date.now(),
      }
      saveAudit(entry)
      ...
      setTimeout(() => { setScreen('results'); setTab('sections') }, 400)
    }
    ...
    try {
      ...
      const auditRes = await fetch('/api/audit', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({ url: normalized, pageContent: fetchData.content || '', fetchMethod: method }),
      })
              ...
              {SCORE_KEYS.map(([k, l], i) => {
                ...
                return (
                  <div key={k} className={styles.sc} style={{ animationDelay: `${i * 0.05}s` }}>
                    ...
                    <div className={styles.scNote}>{note}</div>
              ...
              <div className={styles.infoBanner}>
                ...
                <div>
                  ...
                  <div className={styles.infoBody}>
                    We fetched your live page and read it top to bottom. Each card is a real section of your site — with the actual copy we found, what&apos;s hurting conversion, and exactly how to fix it.
                  </div>
                </div>
              </div>
            ...
            <div className={styles.panel}>
              ...
              <div className={styles.customBlock}>
                ...
                <textarea
                  ...
                  placeholder="Paste a headline, CTA, or paragraph…"
                  value={customInput}
